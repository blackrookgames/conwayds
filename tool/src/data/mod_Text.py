...
class Text:
    ...
    def __init__(self, src):
        ...
        :param row:
            Row of first character, should the text contain any character data
        :param col:
            Column of first character, should the text contain any character data
        :raise TypeError:
    ...
    def __getchars(cls, src):
        ...
        for _item in src:
            if isinstance(_item, Text):
                ...
                chars[_i] = _cast(_TextChar, _item)
                _i += 1
        return chars
