...
namespace game::scns::menu
{
    ...
    void loadScreenData3(const u16* in_data, size_t in_len, u16*& out_data, size_t& out_len)
    {
...
void PageMsgYN::m_enter()
{
    ...
    loadScreenData3(ass::MenuMsgYN::data, ass::MenuMsgYN::size, f_Screen, f_Screen_Len);
